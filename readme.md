...
1）[数据挖掘](./content/数据挖掘.md)

2）[网页抓取](./content/网页抓取.md)

3）[公共数据集](https://github.com/awesomedata/awesome-public-datasets)

4）[Kaggle-数据挖掘和预测竞赛的在线平台](./content/Kaggle.md)

### 4.探索性数据分析/数据整理（清洗）/数据争论（收集）

1）[读取数据和处理](./content/读取数据和处理.md)
...
5）[准确率、精确率和召回率](./content/准确率、精确率和召回率.md)

6）[AUC和ROC](./content/AUC和ROC.md)

7）偏差和方差

8）lift（提升度）

9)  [交叉检验](./content/交叉检验.md)
...
1）[Deep Learning(花书)](./content/Deep Learning中文版.pdf)
